...
const AddAgent = () => {
    ...
    const handleAddAgent = async (event) => {
        ...
        try {
          const success = await SaveItemsAdmin.addAgentSave(email, password, firstName, lastName, phone, address, userName, image, country, expiry, company, begin);
  ...
  return (
    <Box>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap' }} component="form" noValidate onSubmit={handleAddAgent}>
                <TextField
